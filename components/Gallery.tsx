...
export default function Gallery() {
    return (
        <section id="gallery" className="px-4 py-16 md:py-20 md:px-12">
            <div className="mb-24">
                <h2 className="text-sm font-medium tracking-widest uppercase text-white/40 mb-4">( SELECTED WORKS )</h2>
