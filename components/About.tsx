...
export default function About() {
    return (
        <section id="about" className="px-6 py-16 md:py-20 md:px-12 border-t border-black/10">
            <div className="flex flex-col md:flex-row gap-16">
                <div className="w-full md:w-5/12">
                    <h2 className="text-sm font-medium tracking-widest uppercase text-black/40 mb-8">( ABOUT US )</h2>
                ...
                <div className="w-full md:w-7/12 flex flex-col justify-end">
                    <p className="text-lg text-black/50 leading-relaxed max-w-xl self-end text-right">
