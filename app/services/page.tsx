...
export default function ServicesPage() {
    return (
        <main className="bg-white min-h-screen text-black pt-24 md:pt-32 pb-32 md:pb-40 font-sans">
            <FloatingDock />
            <div className="container mx-auto px-6 md:px-12">
                <h1 className="text-[14vw] sm:text-[11vw] md:text-[10vw] leading-[0.85] font-bold tracking-tighter text-black/90 mb-16 break-words">
                    EXPERTISE
                </h1>
                ...
                {/* The Process Section */}
                <section className="mt-24 md:mt-32 pt-24 border-t border-black/10">
                    <h2 className="text-sm font-medium tracking-widest uppercase text-black/40 mb-16">( HOW WE WORK )</h2>

                    <div className="space-y-24">
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                            <div className="w-full md:w-1/4 md:sticky md:top-32">
                                <span className="text-xs uppercase tracking-widest border border-black/20 px-4 py-2 rounded-full">Phase 01</span>
                            </div>
                            <div className="w-full md:w-1/2">
                                <h3 className="text-3xl md:text-5xl font-light mb-6 text-black/90">Discovery & Concept</h3>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                            <div className="w-full md:w-1/4 sticky top-32">
                                <span className="text-xs uppercase tracking-widest border border-black/20 px-4 py-2 rounded-full">Phase 02</span>
                            </div>
                            <div className="w-full md:w-1/2">
                                <h3 className="text-3xl md:text-5xl font-light mb-6 text-black/90">Design & Architecture</h3>
                                <p className="text-black/60 text-lg leading-relaxed mb-8">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                            <div className="w-full md:w-1/4 sticky top-32">
                                <span className="text-xs uppercase tracking-widest border border-black/20 px-4 py-2 rounded-full">Phase 03</span>
                            </div>
                            <div className="w-full md:w-1/2">
                                <h3 className="text-3xl md:text-5xl font-light mb-6 text-black/90">Execution & Production</h3>
                                <p className="text-black/60 text-lg leading-relaxed mb-8">
                ...
                <div className="mt-32 p-8 md:p-12 bg-black/5 backdrop-blur-2xl rounded-3xl border border-black/10 text-center">
                    ...
                    <a href="/contact" className="inline-block px-8 py-4 bg-black text-white rounded-full font-medium hover:scale-105 transition-transform uppercase tracking-widest text-sm">
                        Start a Project
                    </a>
                </div>
            </div>
